...
#
# Generated from Docker Compose version 2.17.3
#
...
function _halostatue_fish_docker_compose_no_subcommand
    for i in (commandline -opc)
        contains -- $i build config cp create down events exec images kill logs ls pause port ps pull push restart rm run start stop top unpause up version; and return 1
    end
    return 0
end
